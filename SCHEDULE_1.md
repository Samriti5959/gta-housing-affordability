...
|---|---|---|---|
| Get the data (download CMHC Excel, set up StatCan API pull) | 1–2 days | Sep 12–13 | Member 1 |
| Extract — load both into the Fabric Lakehouse as tables | 1 day | Sep 13–14 | Member 1 |
| Clean & join (PySpark / Dataflow Gen2) | 2 days | Sep 14–16 | Member 1 |
